            ...
            <section class="section-1">
                <div class="navbar-wrapper">
                    <nav class="navbar">
                        ...
                        <a href="#"> <div class="navbar-logo logo">
                        ...
                        <ul class="nav-list">
                            ...
                            <li class="nav-list-item dropdown-hover">
                                <a href="#" class="nav-list-link show-dropdown">Partners and Developers <i
                                        class="fas fa-chevron-down"></i></a>
                                <ul class="nav-dropdown nav-dropdown-personal">
                                    <li class="nav-dropdown-item dropdown-heading">
                                        <a href="#" class="dropdown-heading-link">
                        ...
                        <div class="navbar-buttons"><a href="#"><button class="navbar-btn login-btn login">Login</button></a>
                            
                        <a href="#"><button class="navbar-btn signup-btn signup"style="background-color: #fff;color:black;">Signup</button></a>
                        </div>
                    </nav>
                </div>
                <div class="banner">
